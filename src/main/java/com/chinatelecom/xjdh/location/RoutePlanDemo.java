package com.chinatelecom.xjdh.location;//package com.chinatelecom.xjdh.location;
//
...
//public class RoutePlanDemo extends BaseActivity
//		implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener, OnGetSuggestionResultListener {
//
...
//	@ViewById(R.id.pre) // 上一个节点
//	Button mBtnPre;
//	@ViewById(R.id.next) // 上一个节点
//	Button mBtnNext;// 下一个节点
//	// @ViewById(R.id.bt_plan)
//	// Button bt_plan;
//	@ViewById(R.id.map) // 地图View
//	MapView mMapView;
//	@ViewById(R.id.end) // 地图View
//	TextView end;
//
//	@Override
...
//		// double latitude = 34.199719;
//		// double longitude = 108.865166;
//		adress = intent.getStringExtra("adress");
//		L.e("latitude:" + latitude + "    longitude:" + longitude + "" + adress);
//		cityname = "长安绿园";
//		// 将来传过来的经纬度
...
//			mSearch.transitSearch((new TransitRoutePlanOption()).from(stNode).city(cityname).to(enNode));
...
//			nodeLocation = ((DrivingRouteLine.DrivingStep) step).getEntrance().getLocation();// 节点经纬度
...
//			if (step instanceof DrivingRouteLine.DrivingStep) {
//				nodeTitle = ((DrivingRouteLine.DrivingStep) step).getInstructions();// 节点行驶路线信息
//			} else if (step instanceof WalkingRouteLine.WalkingStep) {
//				nodeTitle = ((WalkingRouteLine.WalkingStep) step).getInstructions();
//			} else if (step instanceof TransitRouteLine.TransitStep) {
//				nodeTitle = ((TransitRouteLine.TransitStep) step).getInstructions();
