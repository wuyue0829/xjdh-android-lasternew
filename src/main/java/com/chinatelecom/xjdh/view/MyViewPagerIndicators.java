 ...
 *
 */
public class MyViewPagerIndicators extends LinearLayout
{
	/**
	 * 绘制三角形的画笔
	 */
	...
	public MyViewPagerIndicators(Context context)
	{
		this(context, null);
	}

	public MyViewPagerIndicators(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		mTabVisibleCount = a.getInt(R.styleable.MyViewPagerIndicators_item_count,
				COUNT_DEFAULT_TAB);
		...
		mPaint.setColor(Color.parseColor("#f08000"));
	...
	private void resetTextViewColor()
	{
		for (int i = 0; i < getChildCount(); i++)
		{
			...
			if (view instanceof TextView)
			{
				((TextView) view).setTextColor(Color.parseColor("#8F8F8F"));
	...
	private void initTriangle()
	{
		...
		mTriangleHeight = (int) (mTriangleWidth / 2 / Math.sqrt(1));
		mPath.moveTo(0, 0);
	...
	public void setTabItemTitles(String[] title) {
