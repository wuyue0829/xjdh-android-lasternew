...
import com.chinatelecom.xjdh.adapter.DetailAdapter;
...
public class AcceptanceActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new EditQuestionAdapter(this);
	}
	...
	void questionClick(int pos) {
		if (stList.get(pos).getQuestion().equals("随工签名")) {
			ModifyActivity_.intent(this).station_code(station_code).question(stList.get(pos).getQuestion())
