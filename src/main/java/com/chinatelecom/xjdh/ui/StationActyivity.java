...
import com.chinatelecom.xjdh.fragment.SubmittFragment_;
import com.chinatelecom.xjdh.fragment.UncommittFragment_;
...
public class StationActyivity extends BaseActivity {
	...
	@ViewById
	ViewPager viewpager;
	UncommittFragment_ pendingFragment;
	SubmittFragment_ acceptedFragment;
	@RestService
	...
	public void ShowView() {
		pendingFragment = new UncommittFragment_();
		pendingFragment.SetData(station_code);
		acceptedFragment = new SubmittFragment_();
		acceptedFragment.SetData(station_code);
