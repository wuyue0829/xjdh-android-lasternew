...
public class DevQuestionAdapter extends BaseAdapter {
	private Context con;
	private LayoutInflater inflater;
	private List<DevQuestion> data;
	public DevQuestionAdapter(Context con) {
		super();
		this.con = con;
		inflater = LayoutInflater.from(con);
		// TODO Auto-generated constructor stub
	}
	public void setData(List<DevQuestion> data) {
		this.data=data;
