...
public final class FirstLoadFragment_
    extends com.chinatelecom.xjdh.fragment.FirstLoadFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public static FirstLoadFragment_.FragmentBuilder_ builder() {
        return new FirstLoadFragment_.FragmentBuilder_();
    }
    ...
    public void ReadData() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    FirstLoadFragment_.super.ReadData();
                } catch (Throwable e) {
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<FirstLoadFragment_.FragmentBuilder_, com.chinatelecom.xjdh.fragment.FirstLoadFragment>
    {


        @Override
        public com.chinatelecom.xjdh.fragment.FirstLoadFragment build() {
            FirstLoadFragment_ fragment_ = new FirstLoadFragment_();
