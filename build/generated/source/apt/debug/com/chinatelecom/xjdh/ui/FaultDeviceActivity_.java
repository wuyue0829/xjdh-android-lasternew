...
public final class FaultDeviceActivity_
    extends FaultDeviceActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public static FaultDeviceActivity_.IntentBuilder_ intent(Context context) {
        return new FaultDeviceActivity_.IntentBuilder_(context);
    }

    public static FaultDeviceActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new FaultDeviceActivity_.IntentBuilder_(fragment);
    }

    public static FaultDeviceActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new FaultDeviceActivity_.IntentBuilder_(supportFragment);
    }
        ...
        if (lv_stationName_grouping!= null) {
            lv_stationName_grouping.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    FaultDeviceActivity_.this.stationGroupingClicked(position);
                }
    ...
    public void ShowResponse(final ApiResponse apiResp) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                FaultDeviceActivity_.super.ShowResponse(apiResp);
            }
    ...
    public void getData(final int type, final int code) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    FaultDeviceActivity_.super.getData(type, code);
                } catch (Throwable e) {
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<FaultDeviceActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, FaultDeviceActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), FaultDeviceActivity_.class);
            fragment_ = fragment;
        }
        ...
        public FaultDeviceActivity_.IntentBuilder_ roomID(int roomID) {
            return super.extra(ROOM_ID_EXTRA, roomID);
        }

        public FaultDeviceActivity_.IntentBuilder_ station_code(int station_code) {
