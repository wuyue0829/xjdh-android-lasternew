...
public final class EnergyView_
    extends EnergyView
    implements HasViews, OnViewChangedListener
{
    ...
    public EnergyView_(Context context) {
        super(context);
        init_();
    }

    public static EnergyView build(Context context) {
        EnergyView_ instance = new EnergyView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.energy_mian, this);
