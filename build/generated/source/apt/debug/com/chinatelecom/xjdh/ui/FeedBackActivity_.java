    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        mBtnFeedBackSubmit = ((Button) hasViews.findViewById(id.btn_feedback_submit));
        mEtFeedBack = ((EditText) hasViews.findViewById(id.et_feedback_content));
        if (mBtnFeedBackSubmit!= null) {
            mBtnFeedBackSubmit.setOnClickListener(new OnClickListener() {


                @Override
                public void onClick(View view) {
                    FeedBackActivity_.this.onBtnFeedBackClicked();
                }
    ...
    @Override
    public void resolveAddMessageResult(final boolean isSuccess) {
        handler_.post(new Runnable() {


            @Override
            public void run() {
                FeedBackActivity_.super.resolveAddMessageResult(isSuccess);
            }
    ...
    public void uploadFeedBack() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    FeedBackActivity_.super.uploadFeedBack();
                } catch (Throwable e) {
