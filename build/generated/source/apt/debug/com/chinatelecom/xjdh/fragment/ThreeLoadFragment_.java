...
public final class ThreeLoadFragment_
    extends com.chinatelecom.xjdh.fragment.ThreeLoadFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public static ThreeLoadFragment_.FragmentBuilder_ builder() {
        return new ThreeLoadFragment_.FragmentBuilder_();
    }
    ...
    public void ReadData() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    ThreeLoadFragment_.super.ReadData();
                } catch (Throwable e) {
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<ThreeLoadFragment_.FragmentBuilder_, com.chinatelecom.xjdh.fragment.ThreeLoadFragment>
    {


        @Override
        public com.chinatelecom.xjdh.fragment.ThreeLoadFragment build() {
            ThreeLoadFragment_ fragment_ = new ThreeLoadFragment_();
