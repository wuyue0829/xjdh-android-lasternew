    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.edit_view);
    }
    ...
    public static EditActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new EditActivity_.IntentBuilder_(fragment);
    }

    public static EditActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new EditActivity_.IntentBuilder_(supportFragment);
    }
        ...
        if (answer_gridview!= null) {
            answer_gridview.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    EditActivity_.this.seeImageClick(position);
                }
    ...
    public void ShowResponse(final ApiResponseUpLoad resp) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                EditActivity_.super.ShowResponse(resp);
            }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<EditActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, EditActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), EditActivity_.class);
            fragment_ = fragment;
        }
        ...
        public EditActivity_.IntentBuilder_ editimgpath(String[] editimgpath) {
